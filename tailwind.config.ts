...
export default {
  ...
  theme: {
    extend: {
      ...
      /* Rounded, the way a modern product is rounded — not the flat-paper 2px this used to resolve
         to. Every pre-existing rounded-* utility in the app resolves through here, which is why the
         whole interface can change corner language in one line. */
      borderRadius: { DEFAULT: "10px", sm: "6px", md: "10px", lg: "14px", xl: "18px", "2xl": "22px", "3xl": "26px", xl2: "18px", lg2: "10px" },
      boxShadow: {
        card: "var(--shadow-sm)",
        lift: "var(--shadow-lg)",
        press: "none",
